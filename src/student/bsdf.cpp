...
BSDF_Sample BSDF_Mirror::sample(Vec3 out_dir) const {
    ...
    ret.attenuation = reflectance/abs(out_dir.y);    // What is the ratio of reflected/incoming light?
